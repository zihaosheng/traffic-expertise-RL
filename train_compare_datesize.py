...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_save_path', type=str, default='./checkpoint/compare_datasize/')
    parser.add_argument('--logs_path', type=str, default='./logs/compare_datasize/')
    ...
    for model_type in args.model_types:
        for ratio in args.ratios:
            writer = SummaryWriter(args.logs_path + '{}_{}_{}'.format(model_type, ratio,
            ...
            for repeat in range(5):
                ...
                total_num = int(ratio * idm_data.shape[0])
                permutation = np.random.permutation(total_num)
                idm_data = idm_data[permutation]
                ...
                for epoch in tqdm(range(args.epochs)):
                    ...
                    if validaton_loss < best_val_loss:
                        ...
                        torch.save(model.state_dict(), args.model_save_path + '{}_best_val_{}.pth'.format(model_type, ratio))
                ...
                print("{} | dataset size {} | repeat {} | best epoch {} | RMSE is {}".format(model_type, ratio, repeat,
                                                                                             best_epoch, test_RMSE_loss))
                writer.add_scalar('test_rmse/{}'.format(ratio), test_RMSE_loss, repeat + 1)
