...
parser = argparse.ArgumentParser(description='PyTorch TRPO Args')
...
writer = SummaryWriter('logs/' + '{}/TRPO_{}_{}'.format(args.env_name, tag, datetime.now().strftime("%Y-%m-%d_%H-%M-%S")))

checkpoints_path = './checkpoint/{}/TRPO_{}_{}/'.format(args.env_name, str.upper(tag), datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))
